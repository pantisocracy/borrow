...
import com.borrow.mybatis.plugins.PaginationResultSetInterceptor;
import com.borrow.mybatis.plugins.PaginationStatementInterceptor;
 ...
 * Created Time 18:54
 * Created Version 1.1
 * 功能描述：数据库连接类 asePackages=mybatis的mapper所在文件夹
 */
@Configuration
@MapperScan(basePackages = "com.borrow.dao.mapper", sqlSessionFactoryRef = "sqlSessionFactory", sqlSessionTemplateRef = "sqlSessionTemplate")
...
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder, DataSource dataSource) {
        ...
        Properties properties = new Properties();
        //实体文件所在的位置
        entityManagerFactory.setPackagesToScan("com.borrow.entity");
